function t_menu__highlightActiveLinks(e) {
  ...
  Array.prototype.forEach.call(i, (function(e) {
    ...
    if (i) {
      var o = e.href,
      a = "/" === i[0] ? i.slice(1) : i,
      l; - 1 !== r.indexOf("tpost") && (l = "/" + r.slice(0, r.indexOf("tpost"))),
...
function t_menu__updateActiveLinks(e, t) {
  ...
  var r = null,
  i = [],
  o = {}; (e = e.reverse()).forEach((function(e) {
  ...
  e.forEach((function(t, n) {
    t.addEventListener("click", (function() {
      var i = t_menu__getSectionByHref(t); ! t.classList.contains("tooltipstered") && i && i.id && (e.forEach((function(e, t) {
...
function t_menu__getSectionByHref(e) {
  if (e) {
    ...
    var r = t ? t.trim() : "",
    i = -1 !== r.indexOf("#") && r.indexOf("#"); ("number" == typeof i || "number" == typeof(i = -1 !== r.indexOf("/") && r.indexOf("/"))) && (r = r.slice(i + 1));
    var o = 'a[name="' + r + '"]',
...
function t_menu__showFixedMenu(e, t) {
  ...
  if (! (window.innerWidth <= 980) || r) {
    ...
    Array.prototype.forEach.call(o, (function(e) {
      ...
      if (t) { - 1 !== t.indexOf("vh") && (t = Math.floor(window.innerHeight * (parseInt(t) / 100))),
        t = parseInt(t, 10);
  ...
  if (n) {
    ...
    if (a) if (r && r.classList.contains(t.slice(1) + "__mobile_burgerhook") && i) {
      ...
      if (u) {
        ...
        d.href = i,
        c && (d.appendChild(u), c.appendChild(d))
      }
    } else {
      var u = a.querySelector(".t-menuburger");
      a.addEventListener("click", (function(n) {
        if (!n.target.closest("a")) {
          if (a.classList.contains(l)) t_menu__FadeOut(r, 300),
    ...
    window.addEventListener("resize", t_throttle((function() {
      window.innerWidth > 980 && (r && (r.style.opacity = ""), r && (r.style.display = ""), r && (r.style.top = ""), a && a.classList.remove(l)),
      t_menu_checkOverflow(e, t)
    }), 200))
  }
}
...
function t_menu__FadeOut(e, t, n) {
  ...
  var i, o = setInterval((function() {
    e.style.opacity = r,
    (r -= .1) <= .1 && (e.style.opacity = "0", e.style.display = "none", "function" == typeof n && n(), clearInterval(o))
  }), t > 0 ? t / 10 : 40)
}
function t_menu__fadeIn(e, t, n) {
  ...
  var o = setInterval((function() {
    e.style.opacity = r,
    (r += .1) >= 1 && (e.style.opacity = "1", "function" == typeof n && n(), clearInterval(o))
  }), i)
}
function t_menu__slideElement(e, t, n) {
  ...
  o = setInterval((function() {
    ...
    "toTop" === n && r >= t && (e.style.transform = "translateY(-" + t + "px)", e.style.opacity = "0", clearInterval(o)),
    "toBottom" === n && r <= 0 && (e.style.transform = "translateY(0px)", e.style.opacity = "1", clearInterval(o))
  }), 10)
}

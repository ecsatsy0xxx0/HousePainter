  ...
  if (e) {
    ...
    c && Array.prototype.forEach.call(c, (function(t) {
      ...
      a && (t.style.cursor = "pointer", t.addEventListener("mousedown", (function() {
        ...
        var r = 0 === t.button,
        s = 1 === t.button;
        if (c = Date.now(), !(t.target.closest(".t-card__link_second") || t.target.closest(".t-card__link") || t.target.closest(".ql-undercut") || c - e >= 300)) if (r) a.click();
        else if (s) {
...
function t_card__addFocusOnTab(t) {
  if (!window.isMobile) {
    var e = document.getElementById("rec" + t),
    c;
    if (e) if (e.querySelector(".t-card__container")) {
        ...
        Array.prototype.forEach.call(a, (function(t) {
          ...
          t.addEventListener("focus", (function() {
            if ("keyboard" === r) {
              ...
              } else t.classList.add("t-focusable"),
          ...
          t.addEventListener("blur", (function() {
            ...
            } else t.classList.remove("t-focusable"),
